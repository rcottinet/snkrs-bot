...
const runSnkrBot = () => {
	...
	*/
    const date = new Date(2020, 6, 28, 1, 55, 0);
    ...
    (async () => {
        ...
        // #### Login to Account
        await page.waitForSelector('button[data-type="click_navJoinLogin"]');
        console.log('Login button loaded')

        await page.evaluate(() =>
            document.querySelectorAll('button[data-type="click_navJoinLogin"]')[0].click())
        ...
        await waitForUserInput('Are you log in ?')
